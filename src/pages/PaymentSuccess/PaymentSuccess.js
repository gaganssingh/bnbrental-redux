...
class PaymentSuccess extends Component {
    ...
    async componentDidMount() {
        ...
        const successUrl = `${process.env.REACT_APP_API_URL}/payment/success`;
                        ...
                        <div className="col m5">
                            <div className="bordered col">
                                ...
                                <div className="col m12 lower">
                                    <div className="left">
                                        {moment(rd.checkIn).format(
                                            "MMM Do, YYYY"
                                        )}
                                    </div>
                                    <div className="right">
                                        {moment(rd.checkOut).format(
                                            "MMM Do, YYYY"
                                        )}
                                    </div>
                                </div>
                            ...
                            <div className="bordered col">
                                <div className="col m12 upper charges">
                                    ...
                                    <div className="row col m12">
                                        <div className="left">
                                            ${rd.pricePerNight} x {rd.diffDays}{" "}
                                            days
                                        </div>
                                        <div className="right">
                                            ${rd.totalPrice}
                                ...
                                <div className="col m12 row">
                                    To review or make changes to your
                                    reservation, visit your{" "}
                                    <Link to="/account">account page</Link>.
                                </div>
                                <div className="col m12 resv-image">
                                    <img src={vd.imageUrl} alt={vd.title} />
                                </div>
                            </div>
                        </div>
                    </div>
